...
public class SSLServerSocketKeystoreFactory {
     ...
     * @author gpotter2
     */
    public static SSLServerSocket getServerSocketWithCert(int port, String pathToCert, String passwordFromCert, SecureType type, CertFormat certFormat) throws IOException,
        ...
        return getServerSocketWithCert(port, new FileInputStream(f), passwordFromCert, type, certFormat);
    }
     ...
     * @author gpotter2
     */
    public static SSLServerSocket getServerSocketWithCert(int port, InputStream pathToCert, String passwordFromCert, SecureType type, CertFormat certFormat) throws IOException,
            KeyManagementException, NoSuchAlgorithmException, CertificateException, KeyStoreException, UnrecoverableKeyException {
