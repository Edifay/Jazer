...
/*
 * This file was a bit edited by Edifay.
 * To make easier to change between JKS and BKS.
 */
...
public class SSLSocketKeystoreFactory {
     ...
     * @author gpotter2
     */
    public static SSLSocket getSocketWithCert(String ip, int port, String pathToCert, String passwordFromCert, SecureType type, CertFormat certFormat) throws IOException,
        ...
        return getSocketWithCert(ip2, port, new FileInputStream(f), passwordFromCert, type, certFormat);
    }
     ...
     * @author gpotter2
     */
    public static SSLSocket getSocketWithCert(String ip, int port, InputStream pathToCert, String passwordFromCert, SecureType type, CertFormat certFormat) throws IOException,
            KeyManagementException, NoSuchAlgorithmException, CertificateException, KeyStoreException, SocketException {
        InetAddress ip2 = InetAddress.getByName(ip);
        if (ip2 == null) {
            new NullPointerException("The ip must be a correct IP !").printStackTrace();
        ...
        return getSocketWithCert(ip2, port, pathToCert, passwordFromCert, type, certFormat);
    }
     ...
     * @author gpotter2
     */
    public static SSLSocket getSocketWithCert(InetAddress ip, int port, String pathToCert, String passwordFromCert, SecureType type, CertFormat certFormat) throws IOException,
            KeyManagementException, NoSuchAlgorithmException, CertificateException, KeyStoreException, SocketException {
        File f = new File(pathToCert);
        if (!f.exists()) {
            new NullPointerException("The specified path point to a non existing file !");
        ...
        return getSocketWithCert(ip, port, new FileInputStream(f), passwordFromCert, type, certFormat);
    }
     ...
     * @author gpotter2
     */
    public static SSLSocket getSocketWithCert(InetAddress ip, int port, InputStream pathToCert, String passwordFromCert, SecureType type, CertFormat certFormat) throws IOException,
            KeyManagementException, NoSuchAlgorithmException, CertificateException, KeyStoreException, SocketException {
        X509TrustManager[] tmm;
        KeyStore ks = KeyStore.getInstance(certFormat.format);
     ...
     * @author gpotter2
     */
    public static SSLSocket getSocketWithCert(InetAddress ip, int port, InputStream pathToCert, String passwordFromCert, SecureType type, CertFormat certFormat, Proxy proxy) throws IOException,
            KeyManagementException, NoSuchAlgorithmException, CertificateException, KeyStoreException, SocketException {
        X509TrustManager[] tmm;
        KeyStore ks = KeyStore.getInstance(certFormat.format);
        ks.load(pathToCert, passwordFromCert.toCharArray());
